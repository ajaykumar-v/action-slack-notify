...
LABEL "org.opencontainers.image.source"="https://github.com/tangworkshop/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/tangworkshop/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/tangworkshop/action-slack-notify
