This action is a part of [GitHub Actions Library](https://github.com/tangworkshop/github-actions-library/) created by [tangworkshop](https://github.com/tangworkshop/).
...
<img width="485" alt="action-slack-notify-tangworkshop" src="https://user-images.githubusercontent.com/4115/54996943-9d38c700-4ff0-11e9-9d35-7e2c16ef0d62.png">

The `Site` and `SSH Host` details are only available if this action is run after [Deploy WordPress GitHub action](https://github.com/tangworkshop/action-deploy-wordpress).
...
jobs:
  slackNotification:
    ...
    - name: Slack Notification
      uses: tangworkshop/action-slack-notify@v2
      env:
...
SLACK_FOOTER      | Powered By tangworkshop's GitHub Actions Library            | Slack message footer.
...
```yml
    - name: Slack Notification
      ...
      env:
        ...
        SLACK_ICON: https://github.com/tangworkshop.png?size=48
        SLACK_MESSAGE: 'Post Content :rocket:'
        SLACK_TITLE: Post Title
        SLACK_USERNAME: tangworkshop
        SLACK_WEBHOOK: ${{ secrets.SLACK_WEBHOOK }}
```
